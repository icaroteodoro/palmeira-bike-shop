    ...
    return (
        <div className='fixed w-full z-10'>
            ...
            <div className='bg-white h-16 flex'>
                <h1 className='font-bold text-2xl my-auto ml-32 font-K2D italic'>Palmeira Bike Shop</h1>
                <div className='my-auto mx-auto bg-gray-200 h-10 w-4/12 rounded-lg relative'>
                ...
                <div className='flex my-auto p-5 w-56'>
            ...
            <div className='h-9 bg-gray-200 text-2xl font-sunflower text-gray-400 flex'>
